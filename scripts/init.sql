...
-- ============================================================
-- SEED: DEFAULT BRANCHES & ADMIN USER
-- (Arabic text below uses U&'...' Unicode escape syntax so this
--  file remains 100%% ASCII and cannot be corrupted by encoding
--  conversion. PostgreSQL decodes these into real UTF-8 Arabic
--  text when the INSERT runs.)
-- ============================================================

INSERT INTO branches (code, name, name_ar, is_warehouse)
VALUES
    ('MAIN', 'Main Store',     U&'\0627\0644\0645\062a\062c\0631 \0627\0644\0631\0626\064a\0633\064a', FALSE),
    ('WH01', 'Main Warehouse', U&'\0627\0644\0645\0633\062a\0648\062f\0639 \0627\0644\0631\0626\064a\0633\064a', TRUE);

-- Admin user: password = Admin@1234 (bcrypt hash, 12 rounds, verified)
INSERT INTO users (username, email, password_hash, full_name, full_name_ar, role, branch_id)
VALUES (
    'admin',
    'admin@erp.local',
    '$2b$12$QVBncQZPXnu4p.Tw4SyP1u6VgnyHwD3OG1V9h7lmCnJL.iKKBVYva',
    'System Administrator',
    U&'\0645\062f\064a\0631 \0627\0644\0646\0638\0627\0645',
    'ADMIN',
...
INSERT INTO categories (code, name, name_ar) VALUES
    ('ELEC', 'Electrical Parts', U&'\0642\0637\0639 \0643\0647\0631\0628\0627\0626\064a\0629'),
    ('MECH', 'Mechanical Parts', U&'\0642\0637\0639 \0645\064a\0643\0627\0646\064a\0643\064a\0629'),
    ('COOL', 'Cooling Parts',    U&'\0642\0637\0639 \062a\0628\0631\064a\062f'),
    ('HEAT', 'Heating Parts',    U&'\0642\0637\0639 \062a\0633\062e\064a\0646'),
    ('CTRL', 'Control Boards',   U&'\0644\0648\062d\0627\062a \062a\062d\0643\0645'),
    ('SEAL', 'Seals & Gaskets',  U&'\062d\0644\0642\0627\062a \0648\062d\0634\0648\0627\062a'),
    ('PUMP', 'Pumps & Motors',   U&'\0645\0636\062e\0627\062a \0648\0645\062d\0631\0643\0627\062a'),
    ('FILT', 'Filters',          U&'\0641\0644\0627\062a\0631');

-- Sample brands
INSERT INTO brands (name, name_ar) VALUES
    ('Samsung', U&'\0633\0627\0645\0633\0648\0646\062c'),
    ('LG',      U&'\0625\0644 \062c\064a'),
    ('Ariston', U&'\0623\0631\064a\0633\062a\0648\0646'),
    ('Beko',    U&'\0628\064a\0643\0648'),
    ('Zanussi', U&'\0632\0627\0646\0648\0633\064a'),
    ('Toshiba', U&'\062a\0648\0634\064a\0628\0627'),
    ('Sharp',   U&'\0634\0627\0631\0628'),
    ('Carrier', U&'\0643\0627\0631\064a\064a\0631');
